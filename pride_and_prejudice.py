...
# ---- Step 1: Load and clean Pride and Prejudice text ----
# Define paths and URL
DATA_DIR = "texts/"
BOOK_PATH = os.path.join(DATA_DIR, "pride_and_prejudice.txt")
...
if not os.path.exists(BOOK_PATH):
    print(f"Downloading Pride and Prejudice text from {BOOK_URL}...")
    try:
...
ds.save_to_disk("stego_dataset_pride_and_prejudice/")
